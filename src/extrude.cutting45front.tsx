...
const Extrude = () => {
  ...
  useEffect(() => {
    ...
    smallMesh.position.set(
      length / 2 - smallLength / 2, // Centralizado no comprimento da base
      width / 2 - smallWidth / 2, // Centralizado na largura
      7 // Colocado na frente do cubo
    );

    // Rotacionar para que o triângulo esteja com o depth voltado para frente
    smallMesh.rotation.set(0, Math.PI / 2, Math.PI / 2); // Girar no eixo Y para a direita
